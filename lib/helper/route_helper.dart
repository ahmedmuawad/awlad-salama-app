...
/*  static Handler _orderSuccessfulHandler = Handler(handlerFunc: (BuildContext context, Map<String, dynamic> params) {
  ...
  static void setupRouter() {
    ...
    router.define(set_lang,
        handler: _set_langHandler, transitionType: TransitionType.fadeIn);
    router.define(set_address,
        handler: _address2Handler, transitionType: TransitionType.fadeIn);
  }
}
