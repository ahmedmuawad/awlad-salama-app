...
class OrderProvider extends ChangeNotifier {
  ...
  Future<void> getOrderBalance(
      String orderID, String token, BuildContext context) async {
  ...
  Future<void> placeOrder(BuildContext context, PlaceOrderBody placeOrderBody,
